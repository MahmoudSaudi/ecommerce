...
// query, key, value
if ($_GET) { //?
    if (isset($_GET['subId'])) { //key
        //?subId =8
        //value (digit, in db)
        if (is_numeric($_GET['subId'])) {
            $productObj->setSubcategoryId($_GET['subId']);
            $productRes = $productObj->findProduct();
            if ($productRes) {
                $products = $productRes->fetch_all(MYSQLI_ASSOC);
            } else {
                                    ...
                                    <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <a href="product-details.php?proId=<?= $product['id'] ?>">
